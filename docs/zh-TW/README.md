...
<table width="100%">
<tr><th width="40%">我想...</th><th>看這裡</th></tr>
<tr><td>快速把專案跑起來</td><td><a href="#-快速開始">🚀 快速開始</a></td></tr>
<tr><td>看有哪些工具可用</td><td><a href="#️-5-個-mcp-工具">🛠️ 5 個 MCP 工具</a></td></tr>
<tr><td>接入外部分析引擎</td><td><a href="#-分析引擎整合">🔬 分析引擎整合</a></td></tr>
</table>
</details>
